...
export const Bag = ({ games, reference }) => {
        ...
        <>
          <div className="row">
            <div className="table-responsive">
              <table className="shopBagTable table table-border-less align-middle">
                <thead>
                  <tr>
                    <th scope="col">No.</th>
          ...
          <div className="row d-flex justify-content-between mt-5">
            <div className="col-lg-2 d-flex align-align-items-center">
